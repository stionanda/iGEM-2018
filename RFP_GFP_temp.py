...
temp1=int( raw_input('Enter the temperature (choose between 8-37 degrees Celsius): ') ) 
temp2=temp1+273.15
...
class Molecule:
    ...
    def make_RFP(self):
        ...
        random_impulse = (random.randint(-int(Protein_Velocity)*40,int(Protein_Velocity)*40),random.randint(-int(Protein_Velocity)*40,int(Protein_Velocity*40)))
...
def main():
    ...
    def collision_begin_RFP_n1_c2_GFP(arbiter, space, data):
        ...
        probability_colliding=abs(38-temp1)
        rand_no= random.randint(int(90/probability_colliding),100)
        splice_no=[]
        #splice_event=0
        if rand_no >=90:
            RFP_n1.unbond()
            ...
            #print "Npu Splice:",n1_mol
            splice_event=n1_mol
        splice_no.append(splice_event)
        print "Npu Splice:",len(splice_no)
        return True
    ...
    def collision_begin_GFP_n2_c1_RFP(arbiter, space, data):
        ...
        probability_colliding=abs(7-temp1)
        rand_no= random.randint(int(90/probability_colliding),100)
        splice_no=[]
        #splice_event=0
        if rand_no >=90:
            ...
            #print "TerL Splice:",len(c1_mol)
            splice_event=n2_mol
        splice_no.append(splice_event)
        print "TerL Splice:",len(splice_no)
        # #print "TerL Splice:",splice_event
        return True
