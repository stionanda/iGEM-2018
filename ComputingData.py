...
class Particle1:
    def __init__(self, world, mass=1.,species=None):
        self.species=species
        self.world = world
        self.left_bond = None
        self.right_bond = None
...
def main():
    ...
    while True:
        ...
        if mytime%3000==0:
            ...
            n21=0
            for mol in world.molecules:
                if len(mol.particles)==3:
                    n1+=1
                if len(mol.particles)==4:
                    n2+=1
                if len(mol.particles)==5:
                    n3+=1
                if len(mol.particles)==6:
                    n4+=1
                if len(mol.particles)==7:
                    n5+=1
                if len(mol.particles)==8:
                    n6+=1
                if len(mol.particles)==9:
                    n7+=1        
                if len(mol.particles)==10:
                    n8+=1
                if len(mol.particles)==11:
                    n9+=1
                if len(mol.particles)==12:
                    n10+=1   
                if len(mol.particles)==13:
                    n11+=1        
                if len(mol.particles)==14:
                    n12+=1        
                if len(mol.particles)==15:
                    n13+=1         
                if len(mol.particles)==16:
                    n14+=1
                if len(mol.particles)==17:
                    n15+=1
                if len(mol.particles)==18:
                    n16+=1
                if len(mol.particles)==19:
                    n17+=1
                if len(mol.particles)==20:
                    n18+=1
                if len(mol.particles)==21:
                    n19+=1
                if len(mol.particles)==22:
                    n20+=1
                if len(mol.particles)>22:
                    n21+=1
            f.write("{},{},{}\n".format(mytime,"length 1:",n1))
            f.write("{},{},{}\n".format(mytime,"length 2:",n2))
            f.write("{},{},{}\n".format(mytime,"length 3:",n3))
            f.write("{},{},{}\n".format(mytime,"length 4:",n4))
            f.write("{},{},{}\n".format(mytime,"length 5:",n5))
            f.write("{},{},{}\n".format(mytime,"length 6:",n6))
            f.write("{},{},{}\n".format(mytime,"length 7:",n7))
            f.write("{},{},{}\n".format(mytime,"length 8:",n8))
            f.write("{},{},{}\n".format(mytime,"length 9:",n9))
            f.write("{},{},{}\n".format(mytime,"length 10:",n10))
            f.write("{},{},{}\n".format(mytime,"length 11:",n11))
            f.write("{},{},{}\n".format(mytime,"length 12:",n12))
            f.write("{},{},{}\n".format(mytime,"length 13:",n13))
            f.write("{},{},{}\n".format(mytime,"length 14:",n14))
            f.write("{},{},{}\n".format(mytime,"length 15:",n15))
            f.write("{},{},{}\n".format(mytime,"length 16:",n16))
            f.write("{},{},{}\n".format(mytime,"length 17:",n17))
            f.write("{},{},{}\n".format(mytime,"length 18:",n18))
            f.write("{},{},{}\n".format(mytime,"length 19:",n19))
            f.write("{},{},{}\n".format(mytime,"length 20:",n20))
            f.write("{},{},{}\n".format(mytime,"length >20:",n21))
        if mytime%3000==0:
            f.close()
            sys.exit(0)
            break
